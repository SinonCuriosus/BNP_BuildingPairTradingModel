...
#             pos_now = position_exec.loc[date, ticker]
#             if pos_now == 1 and prev_pos == 0 and entry.loc[date, ticker]:
#                 print(f"{date.date()} | BUY  {ticker} at {prices.loc[date, ticker]:.2f}")
#             elif pos_now == 0 and prev_pos == 1 and exit_.loc[date, ticker]:
#                 print(f"{date.date()} | SELL {ticker} at {prices.loc[date, ticker]:.2f}")
#             prev_pos = pos_now
